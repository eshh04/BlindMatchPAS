...
{
    /// <inheritdoc />
    public partial class MergedInitialCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Modern web technologies and frameworks", "Web Development" },
                    { 3, "Network security and cryptography", "Cybersecurity" },
                    { 4, "Statistical models and algorithms", "Machine Learning" },
                    { 5, "Distributed systems and cloud infrastructure", "Cloud Computing" },
                    { 6, "Big data analytics and visualization", "Data Science" },
                    { 7, "Connected devices and smart systems", "Internet of Things" },
                    { 8, "Decentralized ledger technologies", "Blockchain" },
                    { 9, "iOS and Android app development", "Mobile Development" },
                    { 10, "Text and speech processing", "Natural Language Processing" }
                });

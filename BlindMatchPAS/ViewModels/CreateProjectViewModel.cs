// ============================================================================
// File: ViewModels/CreateProjectViewModel.cs
// Purpose: View model for the project submission form with robust validation.
// Pattern: ViewModel with Data Annotations and Regular Expressions.
// Reference: PUSL2020 Coursework - Section 4.1 (Student Project Submission)
// ============================================================================
...
/// <summary>
/// View model for the Student/Create form. Validates all fields using
/// Data Annotations and Regular Expressions before reaching the controller.
/// </summary>

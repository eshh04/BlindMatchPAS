...
public class ProjectService : IProjectService
{
    ...
    /// <inheritdoc/>
    public async Task<Project> CreateProjectAsync(string title, string abstract_, string techStack, int researchAreaId, string studentId)
    {
    ...
    /// <inheritdoc/>
    public async Task<(bool Success, string Error)> EditProjectAsync(int projectId, string title, string abstract_, string techStack, int researchAreaId, string studentId)
    {
